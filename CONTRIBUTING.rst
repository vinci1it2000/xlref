...
If you want to contribute to **xlref** and make it better, your help is very
...
- Create a personal `fork <https://help.github.com/articles/fork-a-repo/
  #fork-an-example-repository>`_ of the `xlref <https://github.com/
  vinci1it2000/xlref>`_ repository on Github.
